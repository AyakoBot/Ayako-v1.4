		...
		async function rankFunction(user) {
			...
			if (res !== undefined && res.rows[0] !== undefined) {
				...
				const embed = new Discord.MessageEmbed()
					.setAuthor(user.tag, user.displayAvatarURL(), 'https://discord.com/api/oauth2/authorize?client_id=650691698409734151&permissions=1642787630327&scope=bot%20applications.commands')
