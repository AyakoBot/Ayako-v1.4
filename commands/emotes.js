	...
	execute(msg, args, client, prefix, command, logchannelid, permLevel, errorchannelID ) {
		...
		if (msg.guild.id == '298954459172700181') {
			EmoteEmbed = new Discord.MessageEmbed()
				...
				.addField('Invite Ayako here:', '([click](https://discord.com/api/oauth2/authorize?client_id=650691698409734151&permissions=1642787630327&scope=bot%20applications.commands))')
