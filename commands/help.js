	...
	execute(msg, args, client, prefix, auth, command, logchannelid, permLevel, errorchannelID) {
		...
		if(cmd2 == 'logging') {
			const FunHelpEmbed = new Discord.MessageEmbed()
				...
				.setAuthor('Ayako Help [Click here to invite me]', client.user.displayAvatarURL(), 'https://discord.com/api/oauth2/authorize?client_id=650691698409734151&permissions=1642787630327&scope=bot%20applications.commands')
			...
			if (cmd3 == '1' || cmd3 == 'useless' || !cmd3){ 
				const FunHelpEmbed = new Discord.MessageEmbed()
					...
					.addFields(
						...
						{ name: '<:AMayakopeek:924071140257841162>`peek`', value:'Peek into chat', inline: true },
				...
				const FunHelpEmbed = new Discord.MessageEmbed()
					...
					.setURL('https://www.patreon.com/Lars_und_so')
					.setAuthor('Ayako Help [Click here to invite me]', client.user.displayAvatarURL(), 'https://discord.com/api/oauth2/authorize?client_id=650691698409734151&permissions=1642787630327&scope=bot%20applications.commands')
					.setDescription('Prefix: `h!`\n**Important** Exclude `[ ]` from your command, those are just signs to tell you that you need to insert something there\n\nNeed help? Join the official Support server [click me](https://discord.gg/GNpcspBbDr)\nWant to invite me to your server? [click me](https://discord.com/api/oauth2/authorize?client_id=650691698409734151&permissions=1642787630327&scope=bot%20applications.commands)')
					.addFields(
		...
		if (cmd2 == 'spez' && msg.guild.id == '298954459172700181') {
			const HelpEmbedAni = new Discord.MessageEmbed()
				...
				.addFields(
					...
					{ name: '`msgs`', value: 'Displays how many messages you sent since last reset', inline: false },
					{ name: '`bypass`', value: 'Bypasses a member and adding the <@&389470002992119810> role to them', inline: false },
		...
		if (cmd2 == 'useless') {
			const HelpEmbed = new Discord.MessageEmbed()
				.setTitle('Click here to find out how Ayako uses your Data')
				.setColor('#b0ff00')
				.setURL('https://ayakobot.com/privacy')
				.setAuthor('Ayako Command Help [Click here to invite me]', client.user.displayAvatarURL(), 'https://discord.com/api/oauth2/authorize?client_id=650691698409734151&permissions=1642787630327&scope=bot%20applications.commands')
				.setDescription('Prefix: `h!`\n**Important** Exclude `[ ]` from your command, those are just signs to tell you that you need to insert something there\n\nNeed help? Join the official Support server [click me](https://discord.gg/GNpcspBbDr)\nWant to invite me to your server? [click me](https://discord.com/api/oauth2/authorize?client_id=650691698409734151&permissions=1642787630327&scope=bot%20applications.commands)')
				.addFields(
					...
					{ name: '`help utility`', value:'Everything about Roles, Selfroles and other helpful utility stuff', inline: true },
