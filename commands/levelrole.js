...
module.exports = {
    ...
    /* eslint-enable */
		...
		if (args[1].toLowerCase() == 'delete') {
			if (!args[0]) return msg.reply('You need to tell me what role you want to delete **IMPORTANT** for this task, I need the Role **ID**');
			if (isNaN(args[0])) return msg.reply('You need to provide the Role **ID**, mentions dont work here.');
			pool.query(`DELETE FROM levelroles WHERE guildid = '${msg.guild.id}' AND roleid = '${args[0]}'`,);
			return msg.reply('The role was successfully deleted.');
		} else{
