		...
		if (res) {
			if (res.rows[0]) {
				const embed = new Discord.MessageEmbed()
					.setAuthor('All Giveaways on '+msg.guild.name, 'https://ayakobot.com', 'https://discord.com/api/oauth2/authorize?client_id=650691698409734151&permissions=1642787630327&scope=bot%20applications.commands')
					.setColor('#b0ff00');
