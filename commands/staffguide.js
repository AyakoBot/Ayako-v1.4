...
module.exports = {
	...
	execute(msg, args, client, prefix, auth, command, logchannelid, permLevel, errorchannelID) {
		...
		const embed = new Discord.MessageEmbed()
			.setAuthor('Easy Ayako Staff Guide', 'https://cdn.discordapp.com/attachments/760152457799401532/813219032802525204/pngfind.com-gavel-png-348962.png', 'https://discord.com/api/oauth2/authorize?client_id=650691698409734151&permissions=1642787630327&scope=bot%20applications.commands')
			.setColor('b0ff00')
