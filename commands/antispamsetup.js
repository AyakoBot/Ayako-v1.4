...
module.exports = {
	...
	/* eslint-enable */
		...
		function start(newsettings, oldsettings) {
			...
			embed1.setAuthor('Ayako AntiSpam Setup Guide', client.user.displayAvatarURL(), 'https://discord.com/api/oauth2/authorize?client_id=650691698409734151&permissions=1642787630327&scope=bot%20applications.commands');
			...
			function step1() {
				msg.channel.awaitMessages(m => m.author.id == msg.author.id,
					...
					if (answer == 'yes') {
						...
						embed2.setAuthor('Ayako AntiSpam Setup Guide', client.user.displayAvatarURL(), 'https://discord.com/api/oauth2/authorize?client_id=650691698409734151&permissions=1642787630327&scope=bot%20applications.commands');
			...
			function step3() {
				...
				embed3.setAuthor('Ayako AntiSpam Setup Guide', client.user.displayAvatarURL(), 'https://discord.com/api/oauth2/authorize?client_id=650691698409734151&permissions=1642787630327&scope=bot%20applications.commands');
			...
			function finish() {
				...
				embed4.setAuthor('Ayako AntiSpam Setup Guide', client.user.displayAvatarURL(), 'https://discord.com/api/oauth2/authorize?client_id=650691698409734151&permissions=1642787630327&scope=bot%20applications.commands');
