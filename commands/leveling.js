...
module.exports = {
	...
	/* eslint-enable */
		...
		if (!args[0]) {
			...
			if (settings.disabled) {leveling = '<:Cross:902269073805701211> Disabled';} else {leveling = '<:Tick:902269933860290650> Enabled';}
			...
			if (settings) {
				...
				embed.setAuthor('Ayako Leveling [Click here to invite me]', client.user.displayAvatarURL(), 'https://discord.com/api/oauth2/authorize?client_id=650691698409734151&permissions=1642787630327&scope=bot%20applications.commands');
