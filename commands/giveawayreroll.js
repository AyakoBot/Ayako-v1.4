				...
				if (res.rows[0].ended) {
					...
					if (m && m.id) {
						...
						const embed = new Discord.MessageEmbed()
							...
							.setColor('b0ff00')
							.setAuthor('Ayako Giveaways', client.user.displayAvatarURL(), 'https://discord.com/api/oauth2/authorize?client_id=650691698409734151&permissions=1642787630327&scope=bot%20applications.commands')
							.setFooter('Ended at');
