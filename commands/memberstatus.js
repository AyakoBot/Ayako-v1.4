  ...
  async execute(msg, args, client, prefix, auth, command, logchannelid, permLevel, errorchannelID) {
	...
	return msg.channel.send('Command unavailable due to missing intents');
		...
		const serverembed = new Discord.MessageEmbed()
			.setAuthor('Ayako Member Screening', 'https://www.ayakobot.com', 'https://discord.com/api/oauth2/authorize?client_id=650691698409734151&permissions=1642787630327&scope=bot%20applications.commands')
			.setColor('b0ff00')
